  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          {
            href: '/admin/knowledge/goals',
            en: 'Goals',
            zh: '目标',
            icon: '',
          },
          {
            href: '/admin/knowledge/certifications',
            en: 'Certifications',
            zh: '认证',
            icon: '',
          },
          {
            href: '/admin/knowledge/supplier-docs',
            en: 'Supplier Docs',
            zh: '供应商文档',
            icon: '',
          },
    ...
    <div>
      <Link
        ...
        style={{
          ...
          color: active && !hasChildren ? 'var(--accent)' : 'var(--text-muted)',
      ...
      >
        ...
        {!collapsed && <span className={hasChildren ? 'text-[11px] font-semibold uppercase tracking-wider' : ''}>{t(item.en, item.zh)}</span>}
      </Link>
